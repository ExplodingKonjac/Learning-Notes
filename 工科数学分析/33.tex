...
\begin{definition}
    对于二元函数 $f(x, y)$ 和定义域内点 $(x_0, y_0)$，定义：
    $$
    \lim_{x \to x_0} \lim_{y \to y_0} f(x, y) = \lim_{x \to x_0} \ab(\lim_{y \to y_0} f(x, y))
    $$
    为 $f(x, y)$ 在 $(x_0, y_0)$ 处先对 $y$ 再对 $x$ 的累次极限。

    同理可定义先对 $x$ 再对 $y$ 的累次极限。
\end{definition}

\begin{theorem}
    对于二元函数 $f(x, y)$ 和定义域内点 $(x_0, y_0)$，若
    $$
    \lim_{(x, y) \to (x_0, y_0)} f(x, y),\ \lim_{x \to x_0} \lim_{y \to y_0} f(x, y),\ \lim_{y \to y_0} \lim_{x \to x_0} f(x, y)
    $$
    均存在，那么它们相等。
\end{theorem}