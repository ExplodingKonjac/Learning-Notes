...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			...
			$$
			\ab(\frac{\dd y}{\dd x} + 1) \sec^2 (x + y) - y - x \frac{\dd y}{\dd x} = 0
			$$
			解得
			$$
			\frac{\dd y}{\dd x} = \frac{y \cos^2 (x + y) - 1}{1 - x \cos^2 (x + y)}
			$$
			再求一次导得到：
			$$
			\frac{\dd^2 y}{\dd x^2} = \frac {2\left (x y + \sec^4 (x + y) + \left ((x - y)^2\tan (x + y) - x - y \right)\sec^2 (x + y) \right)} {\left (x - \sec^2 (x + y) \right)^3}
			$$
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{2)}] 由题得到：
			$$
			\frac{\dd x}{\dd t} = -at \sin t + a \cos t,\ \frac{\dd y}{\dd x} = at \cos t + a \sin t
			$$
			那么：
			$$
			\frac{\dd y}{\dd x} = \frac{at \cos t + a \sin t}{-at \sin t + a \cos t}
			$$
			于是得到：
			$$
			\begin{aligned}
				\frac{\dd^2 y}{\dd x^2} & = \frac{\dd}{\dd t} \ab(\frac{t \cos t + \sin t}{-t \sin t + \cos t}) \cdot \frac{\dd t}{\dd x} \\
				& = \frac{\dd}{\dd t} \ab(\frac{t + \tan t}{1 - t \tan t}) \cdot \frac{1}{-at \sin t + a \cos t} \\
