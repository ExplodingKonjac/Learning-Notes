...
\begin{property}[不定积分的线性性质]
	\ 
	\begin{itemize}
		\item $\displaystyle \int (f(x) \pm g(x)) \dd x = \int f(x) \dd x \pm \int g(x) \dd x$；
		\item $\displaystyle \int cf(x) \dd x = c \int f(x) \dd x$。
	\end{itemize}
\end{property}
...
\begin{itemize}
	\item $\displaystyle \int k \dd x = kx + C$
	\item $\displaystyle \int x^{\mu} \dd x = \frac{x^{1 + \mu}}{1 + \mu} + C\ (\mu \neq -1)$
	\item $\displaystyle \int \frac{\dd x}{x} = \ln |x| + C$
	\item $\displaystyle \int \E^x \dd x = \E^x + C$
	\item $\displaystyle \int \cos x \dd x = \sin x + C$
	\item $\displaystyle \int \sin x \dd x = -\cos x + C$
	\item $\displaystyle \int \sec^2 x \dd x = \tan x + C$
	\item $\displaystyle \int \csc^2 x \dd x = -\cot x + C$
	\item $\displaystyle \int \sec x \tan x \dd x = \sec x + C$
	\item $\displaystyle \int \csc x \cot x \dd x = -\csc x + C$
	\item $\displaystyle \int \frac{\dd x}{\sqrt{1 - x^2}} = \arcsin x + C$
	\item $\displaystyle \int \frac{\dd x}{1 + x^2} = \arctan x + C$
\end{itemize}
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{2)}] $\dd y = -n \sin nx \dd x,\ \dd^2 y = -n^2 \cos nx \dd x^2$；
			\item[\textbf{4)}] $\dd y = \frac{t \dd t}{\sqrt{1 + t^2}},\ \dd^2 y = \frac{\dd t^2}{(1 + t^2)^{3/2}}$；
			\item[\textbf{6)}] $\dd y = -10 (1 + 2r)^{-6} \dd r,\ \dd^2 y = 120 (1 + 2r)^{-7} \dd r^2$；
			\item[\textbf{8)}] $\dd y = -\frac{x}{2} \E^{-\frac{x^2}{4}} \dd x,\ \dd^2 y = \ab(\frac{x^2}{4} - \frac{1}{2}) \E^{-\frac{x^2}{4}} \dd x^2$；
			\item[\textbf{10)}] $\dd y = (3 \sin 2x + (6x - 4) \cos 2x) \dd x,\ \dd^2 y = (12 \cos 2x - (12x - 8) \sin 2x) \dd x^2$；
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{2)}] $\dd y = -\frac{\dd x}{(x + 1)^2} = 0.00025$；
			\item[\textbf{4)}] $\dd y = \sec^2 x \dd x = -0.2$。
		\end{enumerate}
	\end{solution}
\end{problem}
