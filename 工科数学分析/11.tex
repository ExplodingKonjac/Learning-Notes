...
$$
\frac{\dif^n F(x, y)}{\dif x^n} = 0
$$
来求解 $\frac{\dif^n y}{\dif x}$。
...
$$
\frac{\dif^n y}{\dif x^n} = \frac{\frac{\dif^n y}{\dif t^n}}{\ab(\frac{\dif x}{\dif t})^n} = \frac{\psi^{(n)}(t)}{\varphi'(t)^n}
$$
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{1)}] $\displaystyle \frac{\dif y}{\dif x} = \frac{y \E^{\arctan(y/x)} + x \sqrt{x^2 + y^2}}{x \E^{\arctan(y/x)} - y \sqrt{x^2 + y^2}}$；
			\item[\textbf{3)}] $\displaystyle \frac{\dif y}{\dif x} = -\ab(\frac{y}{x})^{\frac{1}{3}}$；
			\item[\textbf{5)}] $\displaystyle \frac{\dif y}{\dif x} = -\frac{y}{\E^y + x}$。
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{2)}] $\displaystyle \frac{\dif y}{\dif x} = 1$；
			\item[\textbf{4)}] $\displaystyle \frac{\dif y}{\dif x} = -\sqrt{\frac{1 + t}{1 - t}}$。
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		$$
		\begin{aligned}
			\frac{\dif y}{\dif x} & = \frac{\frac{\dif(f(\theta) \sin \theta)}{\dif \theta}}{\frac{\dif(f(\theta) \cos \theta)}{\dif \theta}} \\
...
\begin{problem}
	...
	\begin{solution}
		对于 Archimedes 螺线：
		$$
		\frac{\dif y}{\dif x} = \frac{a \sin \theta + a \theta \cos \theta}{a \cos \theta - a \theta \sin \theta}
		$$
		对于双曲螺线：
		$$
		\frac{\dif y}{\dif x} = \frac{-\frac{a}{\theta^2} \sin \theta + \frac{a}{\theta} \cos \theta}{-\frac{a}{\theta^2} \cos \theta - \frac{a}{\theta} \sin \theta} = \frac{-a \sin \theta + a \theta \cos \theta}{-a \cos \theta - a \theta \sin \theta}
		$$
		而当两螺线相交时，有
		$$
