...
$$
\frac{\dd^n y}{\dd x^n} = \frac{\frac{\dd^n y}{\dd t^n}}{\ab(\dv{x}{t})^n} = \frac{\psi^{(n)}(t)}{\varphi'(t)^n}
$$
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{1)}] $\displaystyle \dv{y}{x} = \frac{y \E^{\arctan(y/x)} + x \sqrt{x^2 + y^2}}{x \E^{\arctan(y/x)} - y \sqrt{x^2 + y^2}}$；
			\item[\textbf{3)}] $\displaystyle \dv{y}{x} = -\ab(\frac{y}{x})^{\frac{1}{3}}$；
			\item[\textbf{5)}] $\displaystyle \dv{y}{x} = -\frac{y}{\E^y + x}$。
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		\begin{enumerate}
			\item[\textbf{2)}] $\displaystyle \dv{y}{x} = 1$；
			\item[\textbf{4)}] $\displaystyle \dv{y}{x} = -\sqrt{\frac{1 + t}{1 - t}}$。
		\end{enumerate}
	\end{solution}
\end{problem}
...
\begin{problem}
	...
	\begin{solution}
		$$
		\begin{aligned}
			\dv{y}{x} & = \frac{\frac{\dd(f(\theta) \sin \theta)}{\dd \theta}}{\frac{\dd(f(\theta) \cos \theta)}{\dd \theta}} \\
...
\begin{problem}
	...
	\begin{solution}
		对于 Archimedes 螺线：
		$$
		\dv{y}{x} = \frac{a \sin \theta + a \theta \cos \theta}{a \cos \theta - a \theta \sin \theta}
		$$
		对于双曲螺线：
		$$
		\dv{y}{x} = \frac{-\frac{a}{\theta^2} \sin \theta + \frac{a}{\theta} \cos \theta}{-\frac{a}{\theta^2} \cos \theta - \frac{a}{\theta} \sin \theta} = \frac{-a \sin \theta + a \theta \cos \theta}{-a \cos \theta - a \theta \sin \theta}
		$$
		而当两螺线相交时，有
		$$
