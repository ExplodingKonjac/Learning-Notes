...
\begin{definition}[函数的导数]
	...
	$$
	f'(x_0) = A\ \text{或}\ \left.\frac{\dif f}{\dif x} \right|_{x = x_0} = A
	$$
	这个定义也可以等价于
	$$
...
\begin{theorem}[复合函数的链式求导法则]
	...
	或者使用莱布尼茨记号：
	$$
	\frac{\dif f}{\dif x} = \frac{\dif f}{\dif g} \cdot \frac{\dif g}{\dif x}
	$$
...
\begin{corollary}
	...
	$$
	\frac{\dif g}{\dif x} = \frac{\dif f_1}{\dif f_2} \cdot \frac{\dif f_2}{\dif f_3} \cdot \cdots \cdot \frac{\dif f_{m-1}}{\dif f_m} \cdot \frac{\dif f_m}{\dif x}
	$$
\end{corollary}
