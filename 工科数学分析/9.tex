...
\begin{definition}[函数的导数]
	...
	$$
	f'(x_0) = A\ \text{或}\ \left.\dv{f}{x} \right|_{x = x_0} = A
	$$
	这个定义也可以等价于
	$$
...
\begin{corollary}
	...
	$$
	\dv{g}{x} = \dv{f_1}{f_2} \cdot \dv{f_2}{f_3} \cdot \cdots \cdot \frac{\dd f_{m-1}}{\dd f_m} \cdot \dv{f_m}{x}
	$$
\end{corollary}
